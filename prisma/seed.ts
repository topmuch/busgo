    ...
    invoiceData.push(
      {
        ...
        invoiceNumber: `INV-FB-${String(month.getFullYear()).slice(2)}${String(month.getMonth() + 1).padStart(2, "0")}`,
        total: 2 * 20000,
        numberOfBuses: 2,
        pricePerBus: 20000,
        subtotal: 2 * 20000,
      ...
      },
      {
        ...
        invoiceNumber: `INV-SV-${String(month.getFullYear()).slice(2)}${String(month.getMonth() + 1).padStart(2, "0")}`,
        total: 1 * 20000,
        numberOfBuses: 1,
        pricePerBus: 20000,
        subtotal: 1 * 20000,
