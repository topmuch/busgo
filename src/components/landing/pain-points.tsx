...
export function PainPoints() {
  return (
    <section id="probleme" className="py-20 md:py-28 bg-muted/50">
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-12 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 p-6 md:p-8 text-center"
        >
          <div className="flex items-center justify-center gap-2 mb-2">
            <AlertTriangle className="w-5 h-5 text-red-600 dark:text-red-400" />
            <span className="font-semibold text-red-800 dark:text-red-300 text-sm uppercase tracking-wide">
              Impact financier
            </span>
          </div>
          <p className="text-red-700 dark:text-red-400 font-semibold text-lg md:text-xl">
