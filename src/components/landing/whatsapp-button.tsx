  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg border px-4 py-3 max-w-[220px]"
          >
            <p className="text-sm font-medium text-gray-900">Besoin d&apos;aide ?</p>
            <p className="text-xs text-gray-500 mt-1">
              Écrivez-nous sur WhatsApp. Réponse en moins de 5 min.
            </p>
            <div className="absolute bottom-0 right-6 translate-y-1/2 rotate-45 w-3 h-3 bg-white border-r border-b" />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <motion.button
        ...
        onClick={() => {
          window.open("https://wa.me/221771234567?text=Bonjour%20Bus%20Go%2C%20je%20souhaite%20en%20savoir%20plus.", "_blank");
        }}
